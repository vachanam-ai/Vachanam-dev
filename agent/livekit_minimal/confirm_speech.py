...
_READ_FAILURE = {
    "en": "I couldn't check that right now. Please try again. Would you like me to record a message for the clinic?",
    "te": "ఇప్పుడు అది చెక్ చేయలేకపోయాను అండి. మళ్లీ ప్రయత్నించండి. క్లినిక్ కోసం మీ మెసేజ్ నమోదు చేయనా?",
    "hi": "मैं अभी यह जाँच नहीं कर पाई। कृपया फिर कोशिश करें। क्या मैं क्लिनिक के लिए आपका संदेश दर्ज कर दूँ?",
