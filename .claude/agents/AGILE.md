...
**Layer-0 orientation:** for repo orientation start from `docs/STATUS.md` (current truth) and `docs/PROJECT_STRUCTURE.md` (file-by-file map) instead of reading individual phase docs.
