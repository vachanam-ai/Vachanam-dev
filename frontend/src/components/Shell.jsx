...
function ThemeToggle() {
  ...
  return (
    <button type="button" onClick={toggle}
      ...
      className="relative grid h-9 w-9 shrink-0 place-items-center overflow-hidden rounded-full border border-hairline bg-surface/70 text-teal transition-colors duration-200 hover:bg-teal-mint">
      {/* sun */}
